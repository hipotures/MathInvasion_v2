...
export class HtmlUI {
  ...
  private createUIElements(): void {
    ...
    // Score - top right (positioned inside the canvas)
    this.createUIElement('score', 'Score: 0', canvasLeft + canvasWidth - 100, canvasTop + 10, '#ffffff', 'left');
    
    // Wave - below score
    this.createUIElement('wave', 'Wave: 1', canvasLeft + canvasWidth - 100, canvasTop + 40, '#ffffff', 'left');
  ...
  private createUIElement(
    ...
    // Set alignment
    if (align === 'right') {
      element.style.right = `10px`; // Fixed right margin
