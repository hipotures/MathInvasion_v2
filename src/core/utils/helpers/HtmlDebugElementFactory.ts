/**
 * Factory class responsible for creating specific HTML elements for the Debug UI.
 */
export class HtmlDebugElementFactory {
  ...
  /**
   * Creates all the standard debug UI elements.
   */
